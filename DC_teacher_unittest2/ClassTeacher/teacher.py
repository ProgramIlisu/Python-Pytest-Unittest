# Важно я запускал unitest такому пути PS C:\DEN\PythonProject\DC_teacher_unittest> покрытие тестов 100%
# При запуске по такому пути C:\DEN\PythonProject\DC_teacher_unittest\test_ClassTeacher1> идут ошибки и покрытие тестами в папке test_ClassTeacher1 - Stmts 53 - Miss 51 - Cover 4%
